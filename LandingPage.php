...
<body>
  ...
  <div class="wrapper">
    <header>
      <a href="#" class="logo">Rumah<span>KERTAS</span></a>
      <nav>
    ...
    <section class="hero">
      <h1><span class="purple">Kemudahan</span> dan <span class="purple">kenyamanan</span> dalam membaca</h1>
      <p class="subhead">Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Aliquam facilis deleniti autem reiciendis
        ipsum optio dolore omnis! Ipsum praesentium eius doloribus id,
        animi ratione nulla alias fugit reprehenderit nam deleniti.</p>
    ...
    <div class="data">
      <p class="title">Digital Access</p>
      <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est deleniti enim deserunt odit nihil!
        Architecto!</p>
    </div>
    <section class="more-info">
      <img class="img2" src="Assets/book-2.png" alt="two">
    </section>
  </div>

  <!-- 
      tambah footer disini 
      isinya 
      "logo CR"copyright 2023 by Group D 
    -->
</body>
